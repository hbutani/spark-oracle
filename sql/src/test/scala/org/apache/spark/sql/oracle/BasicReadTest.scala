...
class BasicReadTest extends AbstractTest with PlanTestHelpers {
  ...
  test("TPCDS-Q2") { td =>
    runQry(
      s""" with wscs as
         ...
         | """.stripMargin,
      Map(("TPCDS.WEB_SALES" -> ScanDetails(
  ...
  test("TPCDS-Q4") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin,
      Map(("TPCDS.CUSTOMER" -> ScanDetails(
        List("C_BIRTH_COUNTRY", "C_CUSTOMER_ID", "C_CUSTOMER_SK", "C_EMAIL_ADDRESS", "C_FIRST_NAME", "C_LAST_NAME", "C_LOGIN", "C_PREFERRED_CUST_FLAG"),
        None,
        List(),
        None,
        List()
        ...
        ("TPCDS.STORE_SALES" -> ScanDetails(
          List("SS_CUSTOMER_SK", "SS_EXT_DISCOUNT_AMT", "SS_EXT_LIST_PRICE", "SS_EXT_SALES_PRICE", "SS_EXT_WHOLESALE_COST", "SS_SOLD_DATE_SK"),
        ...
        ("TPCDS.CATALOG_SALES" -> ScanDetails(
          List("CS_BILL_CUSTOMER_SK", "CS_EXT_DISCOUNT_AMT", "CS_EXT_LIST_PRICE", "CS_EXT_SALES_PRICE", "CS_EXT_WHOLESALE_COST", "CS_SOLD_DATE_SK"),
        ...
        ("TPCDS.WEB_SALES" -> ScanDetails(
          List("WS_BILL_CUSTOMER_SK", "WS_EXT_DISCOUNT_AMT", "WS_EXT_LIST_PRICE", "WS_EXT_SALES_PRICE", "WS_EXT_WHOLESALE_COST", "WS_SOLD_DATE_SK"),
    ...
    runQry(
      ...
      Map(("TPCDS.STORE_SALES" -> ScanDetails(
        ...
        ("TPCDS.WEB_RETURNS" -> ScanDetails(
          List("WR_ITEM_SK", "WR_NET_LOSS", "WR_ORDER_NUMBER", "WR_RETURNED_DATE_SK", "WR_RETURN_AMT"),
          None,
          List(),
  ...
  test("TPCDS-Q6") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin,
      Map(("TPCDS.CUSTOMER_ADDRESS" -> ScanDetails(
  ...
  test("TPCDS-Q7") { td =>
    runQry(
      s"""
         ...
         |""".stripMargin,
      Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CDEMO_SK", "SS_COUPON_AMT", "SS_ITEM_SK", "SS_LIST_PRICE", "SS_PROMO_SK", "SS_QUANTITY", "SS_SALES_PRICE", "SS_SOLD_DATE_SK"),
  ...
  test("TPCDS-Q10") { td =>
    runQry(
      ...
      Map(("TPCDS.CUSTOMER" -> ScanDetails(
        ...
        ("TPCDS.CUSTOMER_DEMOGRAPHICS" -> ScanDetails(
          List("CD_CREDIT_RATING", "CD_DEMO_SK", "CD_DEP_COLLEGE_COUNT", "CD_DEP_COUNT", "CD_DEP_EMPLOYED_COUNT", "CD_EDUCATION_STATUS", "CD_GENDER", "CD_MARITAL_STATUS", "CD_PURCHASE_ESTIMATE"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q11") { td =>
    runQry(
      ...
      Map(("TPCDS.WEB_SALES" -> ScanDetails(
        ...
        ("TPCDS.ITEM" -> ScanDetails(
          List("I_CATEGORY", "I_CLASS", "I_CURRENT_PRICE", "I_ITEM_DESC", "I_ITEM_ID", "I_ITEM_SK"),
          Some("I_CATEGORY IN ( ? ? ? )"),
        ...
        ("TPCDS.DATE_DIM" -> ScanDetails(
          List("D_DATE", "D_DATE_SK"),
          Some("((D_DATE IS NOT NULL AND (D_DATE >= ?)) AND (D_DATE <= ?))"),
          List(Literal(Date.valueOf("2001")), Literal(Date.valueOf("2001-01-01"))),
          None,
          List()
        ))))
  }
  ...
  test("TPCDS-Q13") { td =>
    runQry(
      s"""select avg(ss_quantity)
         ...
         |;""".stripMargin,
      Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_ADDR_SK", "SS_CDEMO_SK", "SS_EXT_SALES_PRICE", "SS_EXT_WHOLESALE_COST", "SS_HDEMO_SK", "SS_NET_PROFIT", "SS_QUANTITY", "SS_SALES_PRICE", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
  ...
  test("TPCDS-Q15") { td =>
    runQry(
      s"""
         ...
         | order by ca_zip
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
  ...
  test("TPCDS-Q16") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_CALL_CENTER_SK", "CS_EXT_SHIP_COST", "CS_NET_PROFIT", "CS_ORDER_NUMBER", "CS_SHIP_ADDR_SK", "CS_SHIP_DATE_SK", "CS_WAREHOUSE_SK"),
        ...
        ("TPCDS.CATALOG_RETURNS" -> ScanDetails(
          List("CR_CALL_CENTER_SK", "CR_CATALOG_PAGE_SK", "CR_FEE", "CR_ITEM_SK", "CR_NET_LOSS", "CR_ORDER_NUMBER", "CR_REASON_SK", "CR_REFUNDED_ADDR_SK", "CR_REFUNDED_CASH", "CR_REFUNDED_CDEMO_SK", "CR_REFUNDED_CUSTOMER_SK", "CR_REFUNDED_HDEMO_SK", "CR_RETURNED_DATE_SK", "CR_RETURNED_TIME_SK", "CR_RETURNING_ADDR_SK", "CR_RETURNING_CDEMO_SK", "CR_RETURNING_CUSTOMER_SK", "CR_RETURNING_HDEMO_SK", "CR_RETURN_AMOUNT", "CR_RETURN_AMT_INC_TAX", "CR_RETURN_QUANTITY", "CR_RETURN_SHIP_COST", "CR_RETURN_TAX", "CR_REVERSED_CHARGE", "CR_SHIP_MODE_SK", "CR_STORE_CREDIT", "CR_WAREHOUSE_SK"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q17") { td =>
    runQry(
      s"""
         ...
         |         ,s_state
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_ITEM_SK", "SS_QUANTITY", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        ...
        ("TPCDS.STORE_RETURNS" -> ScanDetails(
          List("SR_CUSTOMER_SK", "SR_ITEM_SK", "SR_RETURNED_DATE_SK", "SR_RETURN_QUANTITY", "SR_TICKET_NUMBER"),
  ...
  test("TPCDS-Q18") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_BILL_CDEMO_SK", "CS_BILL_CUSTOMER_SK", "CS_COUPON_AMT", "CS_ITEM_SK", "CS_LIST_PRICE", "CS_NET_PROFIT", "CS_QUANTITY", "CS_SALES_PRICE", "CS_SOLD_DATE_SK"),
        ...
        ("TPCDS.CUSTOMER" -> ScanDetails(
          List("C_BIRTH_MONTH", "C_BIRTH_YEAR", "C_CURRENT_ADDR_SK", "C_CURRENT_CDEMO_SK", "C_CUSTOMER_SK"),
  ...
  test("TPCDS-Q19") { td =>
    runQry(
      s"""
         ...
         |
         |""".stripMargin,
      Map(("TPCDS.DATE_DIM" -> ScanDetails(
        List("D_DATE_SK", "D_MOY", "D_YEAR"),
        ...
        ("TPCDS.STORE_SALES" -> ScanDetails(
          List("SS_CUSTOMER_SK", "SS_EXT_SALES_PRICE", "SS_ITEM_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
          Some("(SS_CUSTOMER_SK IS NOT NULL AND SS_STORE_SK IS NOT NULL)"),
          List(),
          Some("SS_SOLD_DATE_SK IS NOT NULL"),
          List()
        ...
        ("TPCDS.ITEM" -> ScanDetails(
          List("I_BRAND", "I_BRAND_ID", "I_ITEM_SK", "I_MANAGER_ID", "I_MANUFACT", "I_MANUFACT_ID"),
  ...
  test("TPCDS-Q20") { td =>
    runQry(
      s"""select  i_item_id
         ...
         |         ,i_item_desc
         |         ,revenueratio
         | limit 100;""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
  ...
  test("TPCDS-Q21") { td =>
    runQry(
      s"""select  *
         ...
         |         ,i_item_id
         |  limit 100;""".stripMargin, Map(("TPCDS.INVENTORY" -> ScanDetails(
  ...
  test("TPCDS-Q22") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.INVENTORY" -> ScanDetails(
  ...
  test("TPCDS-Q25") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_ITEM_SK", "SS_NET_PROFIT", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        Some("(SS_CUSTOMER_SK IS NOT NULL AND SS_STORE_SK IS NOT NULL)"),
        List(),
        Some("SS_SOLD_DATE_SK IS NOT NULL"),
        List()
        ...
        ("TPCDS.STORE_RETURNS" -> ScanDetails(
          List("SR_CUSTOMER_SK", "SR_ITEM_SK", "SR_NET_LOSS", "SR_RETURNED_DATE_SK", "SR_TICKET_NUMBER"),
          Some("SR_CUSTOMER_SK IS NOT NULL"),
          List(),
          Some("SR_RETURNED_DATE_SK IS NOT NULL"),
          List()
  ...
  test("TPCDS-Q26") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_BILL_CDEMO_SK", "CS_COUPON_AMT", "CS_ITEM_SK", "CS_LIST_PRICE", "CS_PROMO_SK", "CS_QUANTITY", "CS_SALES_PRICE", "CS_SOLD_DATE_SK"),
  ...
  test("TPCDS-Q27") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CDEMO_SK", "SS_COUPON_AMT", "SS_ITEM_SK", "SS_LIST_PRICE", "SS_QUANTITY", "SS_SALES_PRICE", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
  ...
  test("TPCDS-Q34") { td =>
    runQry(
      s"""
         ...
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_HDEMO_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        ...
        ("TPCDS.CUSTOMER" -> ScanDetails(
          List("C_CUSTOMER_SK", "C_FIRST_NAME", "C_LAST_NAME", "C_PREFERRED_CUST_FLAG", "C_SALUTATION"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q35") { td =>
    runQry(
      s"""
         ...
         |          cd_dep_college_count
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CUSTOMER" -> ScanDetails(
        List("C_CURRENT_ADDR_SK", "C_CURRENT_CDEMO_SK", "C_CUSTOMER_SK"),
        Some("(C_CURRENT_ADDR_SK IS NOT NULL AND C_CURRENT_CDEMO_SK IS NOT NULL)"),
        List(),
        None,
        ...
        ("TPCDS.CUSTOMER_DEMOGRAPHICS" -> ScanDetails(
          List("CD_DEMO_SK", "CD_DEP_COLLEGE_COUNT", "CD_DEP_COUNT", "CD_DEP_EMPLOYED_COUNT", "CD_GENDER", "CD_MARITAL_STATUS"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q36") { td =>
    runQry(
      s"""
         ...
         |   limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_EXT_SALES_PRICE", "SS_ITEM_SK", "SS_NET_PROFIT", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
        Some("SS_STORE_SK IS NOT NULL"),
        List(),
        Some("SS_SOLD_DATE_SK IS NOT NULL"),
        List()
  ...
  test("TPCDS-Q37") { td =>
    runQry(
      s"""
         ...
         | order by i_item_id
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.ITEM" -> ScanDetails(
  ...
  test("TPCDS-Q40") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_ITEM_SK", "CS_ORDER_NUMBER", "CS_SALES_PRICE", "CS_SOLD_DATE_SK", "CS_WAREHOUSE_SK"),
  ...
  test("TPCDS-Q42") { td =>
    runQry(
      s"""
         ...
         | 		,item.i_category
         | limit 100 ;
         |""".stripMargin, Map(("TPCDS.DATE_DIM" -> ScanDetails(
        List("D_DATE_SK", "D_MOY", "D_YEAR"),
        Some("(((D_MOY IS NOT NULL AND D_YEAR IS NOT NULL) AND (D_MOY = ?)) AND (D_YEAR = ?))"),
  ...
  test("TPCDS-Q45") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
  ...
  test("TPCDS-Q46") { td =>
    runQry(
      s"""
         ...
         |   limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_ADDR_SK", "SS_COUPON_AMT", "SS_CUSTOMER_SK", "SS_HDEMO_SK", "SS_NET_PROFIT", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
  ...
  test("TPCDS-Q48") { td =>
    runQry(
      s"""
         ...
         |;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_ADDR_SK", "SS_CDEMO_SK", "SS_NET_PROFIT", "SS_QUANTITY", "SS_SALES_PRICE", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
  ...
  test("TPCDS-Q49") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_ITEM_SK", "WS_NET_PAID", "WS_NET_PROFIT", "WS_ORDER_NUMBER", "WS_QUANTITY", "WS_SOLD_DATE_SK"),
        ...
        ("TPCDS.CATALOG_SALES" -> ScanDetails(
          List("CS_ITEM_SK", "CS_NET_PAID", "CS_NET_PROFIT", "CS_ORDER_NUMBER", "CS_QUANTITY", "CS_SOLD_DATE_SK"),
        ...
        ("TPCDS.STORE_SALES" -> ScanDetails(
          List("SS_ITEM_SK", "SS_NET_PAID", "SS_NET_PROFIT", "SS_QUANTITY", "SS_SOLD_DATE_SK", "SS_TICKET_NUMBER"),
  ...
  test("TPCDS-Q50") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_ITEM_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        Some("(SS_CUSTOMER_SK IS NOT NULL AND SS_STORE_SK IS NOT NULL)"),
        List(),
        Some("SS_SOLD_DATE_SK IS NOT NULL"),
        List()
        ...
        ("TPCDS.STORE" -> ScanDetails(
          List("S_CITY", "S_COMPANY_ID", "S_COUNTY", "S_STATE", "S_STORE_NAME", "S_STORE_SK", "S_STREET_NAME", "S_STREET_NUMBER", "S_STREET_TYPE", "S_SUITE_NUMBER", "S_ZIP"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q61") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_EXT_SALES_PRICE", "SS_ITEM_SK", "SS_PROMO_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK"),
  ...
  test("TPCDS-Q62") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_SHIP_DATE_SK", "WS_SHIP_MODE_SK", "WS_SOLD_DATE_SK", "WS_WAREHOUSE_SK", "WS_WEB_SITE_SK"),
  ...
  test("TPCDS-Q64") { td =>
    runQry(
      s"""
         ...
         |       ,cnt_2;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_ADDR_SK", "SS_CDEMO_SK", "SS_COUPON_AMT", "SS_CUSTOMER_SK", "SS_HDEMO_SK", "SS_ITEM_SK", "SS_LIST_PRICE", "SS_PROMO_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER", "SS_WHOLESALE_COST"),
        ...
        ("TPCDS.CUSTOMER" -> ScanDetails(
          List("C_CURRENT_ADDR_SK", "C_CURRENT_CDEMO_SK", "C_CURRENT_HDEMO_SK", "C_CUSTOMER_SK", "C_FIRST_SALES_DATE_SK", "C_FIRST_SHIPTO_DATE_SK"),
  ...
  test("TPCDS-Q65") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE" -> ScanDetails(
  ...
  test("TPCDS-Q66") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_EXT_SALES_PRICE", "WS_NET_PAID", "WS_QUANTITY", "WS_SHIP_MODE_SK", "WS_SOLD_DATE_SK", "WS_SOLD_TIME_SK", "WS_WAREHOUSE_SK"),
        ...
        ("TPCDS.WAREHOUSE" -> ScanDetails(
          List("W_CITY", "W_COUNTRY", "W_COUNTY", "W_STATE", "W_WAREHOUSE_NAME", "W_WAREHOUSE_SK", "W_WAREHOUSE_SQ_FT"),
          None,
          List(),
          None,
          List()
        ...
        ("TPCDS.CATALOG_SALES" -> ScanDetails(
          List("CS_NET_PAID_INC_TAX", "CS_QUANTITY", "CS_SALES_PRICE", "CS_SHIP_MODE_SK", "CS_SOLD_DATE_SK", "CS_SOLD_TIME_SK", "CS_WAREHOUSE_SK"),
  ...
  test("TPCDS-Q68") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_ADDR_SK", "SS_CUSTOMER_SK", "SS_EXT_LIST_PRICE", "SS_EXT_SALES_PRICE", "SS_EXT_TAX", "SS_HDEMO_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        Some("(((SS_STORE_SK IS NOT NULL AND SS_HDEMO_SK IS NOT NULL) AND SS_ADDR_SK IS NOT NULL) AND SS_CUSTOMER_SK IS NOT NULL)"),
        List(),
        Some("SS_SOLD_DATE_SK IS NOT NULL"),
        List()
  ...
  test("TPCDS-Q69") { td =>
    runQry(
      s"""
        ...
        ("TPCDS.CUSTOMER_DEMOGRAPHICS" -> ScanDetails(
          List("CD_CREDIT_RATING", "CD_DEMO_SK", "CD_EDUCATION_STATUS", "CD_GENDER", "CD_MARITAL_STATUS", "CD_PURCHASE_ESTIMATE"),
          None,
          List(),
          None,
          List()
  ...
  test("TPCDS-Q72") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_BILL_CDEMO_SK", "CS_BILL_HDEMO_SK", "CS_ITEM_SK", "CS_ORDER_NUMBER", "CS_PROMO_SK", "CS_QUANTITY", "CS_SHIP_DATE_SK", "CS_SOLD_DATE_SK"),
  ...
  test("TPCDS-Q75") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
        List("CS_EXT_SALES_PRICE", "CS_ITEM_SK", "CS_ORDER_NUMBER", "CS_QUANTITY", "CS_SOLD_DATE_SK"),
        None,
        List(),
        Some("CS_SOLD_DATE_SK IS NOT NULL"),
        List()
        ...
        ("TPCDS.ITEM" -> ScanDetails(
          List("I_BRAND_ID", "I_CATEGORY", "I_CATEGORY_ID", "I_CLASS_ID", "I_ITEM_SK", "I_MANUFACT_ID"),
        ...
        ("TPCDS.STORE_SALES" -> ScanDetails(
          List("SS_EXT_SALES_PRICE", "SS_ITEM_SK", "SS_QUANTITY", "SS_SOLD_DATE_SK", "SS_TICKET_NUMBER"),
          None,
          List(),
          Some("SS_SOLD_DATE_SK IS NOT NULL"),
          List()
        ...
        ("TPCDS.WEB_SALES" -> ScanDetails(
          List("WS_EXT_SALES_PRICE", "WS_ITEM_SK", "WS_ORDER_NUMBER", "WS_QUANTITY", "WS_SOLD_DATE_SK"),
          None,
          List(),
          Some("WS_SOLD_DATE_SK IS NOT NULL"),
          List()
  ...
  test("TPCDS-Q78") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_ITEM_SK", "SS_QUANTITY", "SS_SALES_PRICE", "SS_SOLD_DATE_SK", "SS_TICKET_NUMBER", "SS_WHOLESALE_COST"),
        None,
        List(),
        Some("SS_SOLD_DATE_SK IS NOT NULL"),
        List()
        ...
        ("TPCDS.WEB_SALES" -> ScanDetails(
          List("WS_BILL_CUSTOMER_SK", "WS_ITEM_SK", "WS_ORDER_NUMBER", "WS_QUANTITY", "WS_SALES_PRICE", "WS_SOLD_DATE_SK", "WS_WHOLESALE_COST"),
          Some("WS_BILL_CUSTOMER_SK IS NOT NULL"),
          List(),
          Some("WS_SOLD_DATE_SK IS NOT NULL"),
          List()
        ...
        ("TPCDS.CATALOG_SALES" -> ScanDetails(
          List("CS_BILL_CUSTOMER_SK", "CS_ITEM_SK", "CS_ORDER_NUMBER", "CS_QUANTITY", "CS_SALES_PRICE", "CS_SOLD_DATE_SK", "CS_WHOLESALE_COST"),
          Some("CS_BILL_CUSTOMER_SK IS NOT NULL"),
          List(),
          Some("CS_SOLD_DATE_SK IS NOT NULL"),
          List()
  ...
  test("TPCDS-Q80") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_EXT_SALES_PRICE", "SS_ITEM_SK", "SS_NET_PROFIT", "SS_PROMO_SK", "SS_SOLD_DATE_SK", "SS_STORE_SK", "SS_TICKET_NUMBER"),
        ...
        ("TPCDS.CATALOG_SALES" -> ScanDetails(
          List("CS_CATALOG_PAGE_SK", "CS_EXT_SALES_PRICE", "CS_ITEM_SK", "CS_NET_PROFIT", "CS_ORDER_NUMBER", "CS_PROMO_SK", "CS_SOLD_DATE_SK"),
        ...
        ("TPCDS.WEB_SALES" -> ScanDetails(
          List("WS_EXT_SALES_PRICE", "WS_ITEM_SK", "WS_NET_PROFIT", "WS_ORDER_NUMBER", "WS_PROMO_SK", "WS_SOLD_DATE_SK", "WS_WEB_SITE_SK"),
  ...
  test("TPCDS-Q81") { td =>
    runQry(
      s"""
         ...
         |                  ,ca_location_type,ctr_total_return
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CATALOG_RETURNS" -> ScanDetails(
        List("CR_RETURNED_DATE_SK", "CR_RETURNING_ADDR_SK", "CR_RETURNING_CUSTOMER_SK", "CR_RETURN_AMT_INC_TAX"),
        ...
        ("TPCDS.CUSTOMER" -> ScanDetails(
          List("C_CURRENT_ADDR_SK", "C_CUSTOMER_ID", "C_CUSTOMER_SK", "C_FIRST_NAME", "C_LAST_NAME", "C_SALUTATION"),
          Some("C_CURRENT_ADDR_SK IS NOT NULL"),
          List(),
          None,
          List()
        ...
        ("TPCDS.CUSTOMER_ADDRESS" -> ScanDetails(
          List("CA_ADDRESS_SK", "CA_CITY", "CA_COUNTRY", "CA_COUNTY", "CA_GMT_OFFSET", "CA_LOCATION_TYPE", "CA_STATE", "CA_STREET_NAME", "CA_STREET_NUMBER", "CA_STREET_TYPE", "CA_SUITE_NUMBER", "CA_ZIP"),
          Some("(CA_STATE IS NOT NULL AND (CA_STATE = ?))"),
          List(Literal("GA")),
          None,
          List()
  ...
  test("TPCDS-Q82") { td =>
    runQry(s"""
              ...
              | group by i_item_id,i_item_desc,i_current_price
              | order by i_item_id
              |  limit 100;""".stripMargin, Map(("TPCDS.ITEM" -> ScanDetails(
      List("I_CURRENT_PRICE", "I_ITEM_DESC", "I_ITEM_ID", "I_ITEM_SK", "I_MANUFACT_ID"),
      Some("(((I_CURRENT_PRICE IS NOT NULL AND (I_CURRENT_PRICE >= ?)) AND (I_CURRENT_PRICE <= ?)) AND I_MANUFACT_ID IN ( ? ? ? ? ))"),
  ...
  test("TPCDS-Q83") { td =>
    runQry(
      s"""
         ...
         |         ,sr_item_qty
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_RETURNS" -> ScanDetails(
  ...
  test("TPCDS-Q84") { td =>
    runQry(
      s"""
         ...
         |  limit 100;
         |""".stripMargin, Map(("TPCDS.CUSTOMER" -> ScanDetails(
        List("C_CURRENT_ADDR_SK", "C_CURRENT_CDEMO_SK", "C_CURRENT_HDEMO_SK", "C_CUSTOMER_ID", "C_FIRST_NAME", "C_LAST_NAME"),
  ...
  test("TPCDS-Q85") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_ITEM_SK", "WS_NET_PROFIT", "WS_ORDER_NUMBER", "WS_QUANTITY", "WS_SALES_PRICE", "WS_SOLD_DATE_SK", "WS_WEB_PAGE_SK"),
        Some("WS_WEB_PAGE_SK IS NOT NULL"),
        List(),
        Some("WS_SOLD_DATE_SK IS NOT NULL"),
        List()
        ...
        ("TPCDS.WEB_RETURNS" -> ScanDetails(
          List("WR_FEE", "WR_ITEM_SK", "WR_ORDER_NUMBER", "WR_REASON_SK", "WR_REFUNDED_ADDR_SK", "WR_REFUNDED_CASH", "WR_REFUNDED_CDEMO_SK", "WR_RETURNING_CDEMO_SK"),
  ...
  test("TPCDS-Q91") { td =>
    runQry(
      s"""
         ...
         |""".stripMargin, Map(("TPCDS.CALL_CENTER" -> ScanDetails(
        ...
        ("TPCDS.CATALOG_RETURNS" -> ScanDetails(
          List("CR_CALL_CENTER_SK", "CR_NET_LOSS", "CR_RETURNED_DATE_SK", "CR_RETURNING_CUSTOMER_SK"),
        ...
        ("TPCDS.CUSTOMER" -> ScanDetails(
          List("C_CURRENT_ADDR_SK", "C_CURRENT_CDEMO_SK", "C_CURRENT_HDEMO_SK", "C_CUSTOMER_SK"),
          Some("((C_CURRENT_ADDR_SK IS NOT NULL AND C_CURRENT_CDEMO_SK IS NOT NULL) AND C_CURRENT_HDEMO_SK IS NOT NULL)"),
          List(),
          None,
          List()
  ...
  test("TPCDS-Q93") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.STORE_SALES" -> ScanDetails(
        List("SS_CUSTOMER_SK", "SS_ITEM_SK", "SS_QUANTITY", "SS_SALES_PRICE", "SS_TICKET_NUMBER"),
        None,
        List(),
        None,
        List()
  ...
  test("TPCDS-Q94") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_EXT_SHIP_COST", "WS_NET_PROFIT", "WS_ORDER_NUMBER", "WS_SHIP_ADDR_SK", "WS_SHIP_DATE_SK", "WS_WAREHOUSE_SK", "WS_WEB_SITE_SK"),
  ...
  test("TPCDS-Q95") { td =>
    runQry(
      s"""
         ...
         | limit 100;
         |""".stripMargin, Map(("TPCDS.WEB_SALES" -> ScanDetails(
        List("WS_EXT_SHIP_COST", "WS_NET_PROFIT", "WS_ORDER_NUMBER", "WS_SHIP_ADDR_SK", "WS_SHIP_DATE_SK", "WS_WEB_SITE_SK"),
        Some("((WS_SHIP_DATE_SK IS NOT NULL AND WS_SHIP_ADDR_SK IS NOT NULL) AND WS_WEB_SITE_SK IS NOT NULL)"),
        List(),
        None,
        List()
  ...
  test("TPCDS-Q99") { td =>
    runQry(s"""
              ...
              |        ,cc_name
              | limit 100;""".stripMargin, Map(("TPCDS.CATALOG_SALES" -> ScanDetails(
      List("CS_CALL_CENTER_SK", "CS_SHIP_DATE_SK", "CS_SHIP_MODE_SK", "CS_SOLD_DATE_SK", "CS_WAREHOUSE_SK"),
