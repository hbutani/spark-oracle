...
order by
 ...
 """.stripMargin
  ...
  val q13 = s""" select avg(ss_quantity)
...
; """.stripMargin
  ...
  val q14_1 = s""" with cross_items as
...
order by qoh, i_product_name, i_brand, i_class, i_category
 ...
 """.stripMargin
  ...
  val q23_1 = s"""  with frequent_ss_items as
...
from
 ...
 from (select cs_quantity*cs_list_price sales
  ...
  val q23_2 = s"""  with frequent_ss_items as
 (select substr(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
      ,date_dim
      ,item
